...
export const UPDATE_QUEST_NAME_MODAL_ID = 'UPDATE_QUEST_NAME_MODAL'

interface UpdateQuestNameProps {
  quest: AssignQuest
}
...
export function UpdateQuestNameModal({ quest }: UpdateQuestNameProps) {
  ...
  const closeModal = () => {
    removeModal(UPDATE_QUEST_NAME_MODAL_ID)
  }
      ...
      <Stack p={2} width={1} height={1} justifyContent="space-between" spacing={2}>
        <Stack spacing={3}>
          ...
          <TextField
            ...
            autoFocus
            label="퀘스트 이름"
            placeholder="변경할 퀘스트 이름을 입력해주세요"
            variant="standard"
            slotProps={{
